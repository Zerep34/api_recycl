...
public class UserController {
    ...
    @PostMapping("/user")
    public @ResponseBody
    String getUser(@RequestParam String login, @RequestParam String password) throws Exception {
        try {
    ...
    public @ResponseBody
    String block(@RequestParam String login) throws Exception {
        try {
    ...
    public @ResponseBody
    String addUser(@RequestParam String nom,
