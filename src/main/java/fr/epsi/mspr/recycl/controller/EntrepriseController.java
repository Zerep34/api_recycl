...
import fr.epsi.mspr.recycl.repository.V_ENTREPRISERepository;
...
public class EntrepriseController {
    ...
    @Autowired
    private V_ENTREPRISERepository v_entrepriseRepository;

    @PostMapping("/entreprise")
    public @ResponseBody String getUser(@RequestParam String name) throws Exception {
